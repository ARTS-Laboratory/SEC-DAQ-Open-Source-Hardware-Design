...
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
int CapOffset = 5;     // Cap offset in Pf. Max of 96 pF.                  //////////
...
//dataFile.print(SampleT,DEC);
  ...
  //Serial.println("   ");
      ...
      dataFile.print(timeArray[i],DEC);
      dataFile.print("\t"); 
      dataFile.print(CH0Array[i],DEC);
      dataFile.print("\t"); 
      dataFile.print(CH1Array[i],DEC);
      dataFile.print("\t"); 
      dataFile.print(CH2Array[i],DEC);
      dataFile.print("\t"); 
      dataFile.println(CH3Array[i],DEC);    
