...
// All this looping is just changing the capdac
...
delay (100);
    ...
    MessConfval24=0;
      ...
      Config(0x08,MessConfval11,MessConfval21); //  MessConfval11,MessConfval21 = 00010000 , 00000000
      Config(0x0C,00000100,10000000); // always the same, only updates the enabled measurment every time for the foccert measurment.
      ...
      */
      ...
      delay(10);
      Mess1=getdata(0x00);
      Config(0x09,MessConfval12,MessConfval22);
      Config(0x0C,00000100,01000000);
      delay(10);
      Mess2=getdata(0x02);
      Config(0x0A,MessConfval13,MessConfval23);
      Config(0x0C,00000100,00100000);
      delay(10);
      Mess3=getdata(0x04);
      Config(0x0B,MessConfval14,MessConfval24);
      Config(0x0C,00000100,00010000);
      delay(10);
      Mess4=getdata(0x06);
