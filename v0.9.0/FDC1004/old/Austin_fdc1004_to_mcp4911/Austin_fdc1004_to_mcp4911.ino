...
//delay (100);
      ...
      int data;
      data = map(Cap1, 80, 100, 0, 1023);
      //analogWrite(9, val);
      
      Serial.print("data -  : ");
      Serial.println(data,DEC);
      
      int new_data = dataPrep(data);

      byte MSB = highByte(new_data);   //mask LSB, shift 8 bits to the right
      byte LSB = lowByte(new_data);             //mask MSB, no need to shift
