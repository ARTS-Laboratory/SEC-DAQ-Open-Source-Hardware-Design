 ...
 * CDC (24 bit) onto the 16 bit DAC.  This is then passed to the cRIO and read at 15 bits (as we only use 0 – 5V).  
...
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
int CapOffset0 = 73;     // Cap offset in Pf. Max of 96 pF.                  //////////
int CapOffset1 = 73;     // Cap offset in Pf. Max of 96 pF.   
...
void setup()
{
  ...
  if (CapOffset0 != 0)    // check if the CapOffset is greater than zero, and set the correct regesiters.
    {
     // set the capoffset for channel 0 
     CapDAC = CapOffset0/3.125; // convert the pF value to the interger for a single sided capacitance measurment
     ...
     // set it again for channel 1 

     CapDAC = CapOffset1/3.125; // convert the pF value to the interger for a single sided capacitance measurment
     CapDAC = CapDAC <<5;  // shift the set value four to the left to allow for 0s in bits 0:4
    ...
    MapLow  = CapOffset1 - 16;  
    MapHigh = CapOffset1 + 16;  
    }
...
void loop()
{
  ...
  */
      ...
      */
      ...
      CapCh1 = (((float) tempdata1) / 524288 ) + CapOffset0-16;   // changes data to capacitance.  could remove to speed up code.
      CapCh2 = (((float) tempdata2) / 524288 ) + CapOffset1-16;   
...
// read three sensors and append to the string:
  ...
  dataString += "\t";
  dataString += String(CapCh1);
  dataString += "\t";
  dataString += String(CapCh2);
  dataString += "\t";
  dataString += String(CapCh3);
  dataString += "\t";
  dataString += String(CapCh4);
