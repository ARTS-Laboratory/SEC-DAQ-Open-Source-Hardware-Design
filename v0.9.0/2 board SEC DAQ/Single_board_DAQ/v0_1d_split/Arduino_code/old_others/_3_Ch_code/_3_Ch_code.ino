...
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
int CapOffset1 = 55;     // Cap offset in Pf. Max of 96 pF.                  //////////
int CapOffset2 = 75;
int CapOffset3 = 95;
...
// Channel 2
     CapDAC = CapOffset2/3.125; // convert the pF value to the interger for a single sided capacitance measurment
     CapDAC = CapDAC <<5;  // shift the set value four to the left to allow for 0s in bits 0:4
     ...
     // Channel 3
     CapDAC = CapOffset3/3.125; // convert the pF value to the interger for a single sided capacitance measurment
     CapDAC = CapDAC <<5;  // shift the set value four to the left to allow for 0s in bits 0:4
...
void loop()
{
  ...
  */
      ...
      */
      ...
      CapCh1 = (((float) tempdata1) / 524288 ) + CapOffset1-16;   // changes data to capacitance.  could remove to speed up code.
      CapCh2 = (((float) tempdata2) / 524288 ) + CapOffset2-16;   
      CapCh3 = (((float) tempdata3) / 524288 ) + CapOffset3-16;   
