...
int val_sample_0 = 0;   
int val_sample_1 = 0;   
int val_hold = 0; // the trigger sets the hold value, holds on 1, releases on zero. 
                  // setting the trigger to ON turns hold to 0, so no hold happens 
...
val_hold = digitalRead(trigger);   // read the input pin   
